...
Description: The user’s most recent position in the episode. Set if the supplied access token is a user token and has the scope <code class="highlighter-rouge">user-read-playback-position</code>.
