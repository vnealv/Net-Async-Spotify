...
Type: String
Description: A link to the Web API endpoint providing full details of the followers; <code class="highlighter-rouge">null</code> if not available. Please note that this will always be set to null, as the Web API does not support it at the moment.
